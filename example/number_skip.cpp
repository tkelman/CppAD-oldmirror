...
$index number_skip, example$$
$index example, number_skip$$
$index optimize, conditional expression$$
$index condition, expression optimize$$
$index expression, conditional optimize$$

$code
$verbatim%example/number_skip.cpp%0%// BEGIN C++%// END C++%1%$$
$$
