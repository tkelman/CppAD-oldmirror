...
/*
$begin pthread_multi_newton.cpp$$
$spell
	pthread
$$

$index multi_newton, pthread$$
$index pthread, multi_newton$$
$index newton, pthread$$

$section Pthread Implementation of Multi-Threaded Newton's Method$$
