...
/*
$begin bthread_sum_i_inv.cpp$$
$spell
	inv
	bthread
$$
$index bthread, sum_i_inv$$
$index sum_i_inv, bthread$$


$section Boost Threads Implementation of Summation of 1/i$$
...
$head Source$$
$code
$verbatim%multi_thread/bthread/sum_i_inv.cpp%0%// BEGIN PROGRAM%// END PROGRAM%1%$$
$$
