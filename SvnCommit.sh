...
#
# ----------------------------------------------------------------------
log_entry="fix warnings generated by gcc version 4 compiler

SvnCommit.sh: file that make this commit.
WhatsNew06.omh: user's view of the changes not yet in trunk.
TrackNewDel.h: comment out unused argument name.
CppAD_vector.h: assing data before call (even though unused parameter).
"
# 
add_list="
"
