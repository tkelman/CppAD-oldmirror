# ifndef CppADLuInvertIncluded
# define CppADLuInvertIncluded
...
$head Syntax$$ $code# include <CppAD/LuInvert.h>$$
$pre
$$
...
$head Include$$
The file $code CppAD/LuInvert.h$$ is included by $code CppAD/CppAD.h$$
