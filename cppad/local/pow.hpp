...
# endif
	...
	{	if( var_y )
		{	// result = variable^variable
			...
			Base second   = log(x.value_);
			Base third    = second * y.value_;
			result.taddr_ = tape->Rec.PutOp(
				PowvvOp, result.value_, second, third
			);
		...
		{	// result = variable^parameter 
			...
			Base third  = second * y.value_;
			result.taddr_ = tape->Rec.PutOp(
				PowvpOp, result.value_, second, third
			);
	...
	{	if( IdenticalZero(x.value_) )
		...
		{	// result = variable^parameter 
			...
			Base third  = second * y.value_;
			result.taddr_ = tape->Rec.PutOp(
				PowpvOp, result.value_, second, third
			);
