...
# endif
	...
	{	if( var_right )
		{	// result = variable - variable
			...
			result.taddr_ = tape->Rec.PutOp(SubvvOp,result.value_);
		...
		{	// result = variable - parameter
			...
			// put operator in the tape
			result.taddr_ = tape->Rec.PutOp(SubvpOp,result.value_);
			// make result a variable
			result.id_ = tape->id_;
		}
	}
	...
	{	// result = parameter - variable
		...
		// put operator in the tape
		result.taddr_ = tape->Rec.PutOp(SubpvOp,result.value_);
		// make result a variable
		result.id_ = tape->id_;
	}
	return result;
