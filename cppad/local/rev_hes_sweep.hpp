...
)
{
	...
	vector< size_set > set_r;    // set forward Jacobian sparsity for x
	vector< size_set > set_u;    // set reverse Hessian sparsity for y
	vector< size_set > set_v;    // set reverse Hessian sparsity for x
	//
