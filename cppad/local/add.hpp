...
# endif
	...
	{	if( var_right )
		{	// result = variable + variable
			...
			result.taddr_ = tape->Rec.PutOp(AddvvOp,result.value_);
		...
		{	// result = variable + parameter
			...
			// put operator in the tape
			result.taddr_ = tape->Rec.PutOp(AddvpOp,result.value_);
			// make result a variable
			result.id_ = tape->id_;
		}
	}
	...
	{	if( IdenticalZero(value_) )
		...
		{	// result = parameter + variable
			...
			// put operator in the tape
			result.taddr_ = tape->Rec.PutOp(AddpvOp,result.value_);
			// make result a variable
			result.id_ = tape->id_;
		}
	}
