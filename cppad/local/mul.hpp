...
# endif
	...
	{	if( var_right )
		{	// result = variable * variable
			...
			result.taddr_ = tape->Rec.PutOp(MulvvOp,result.value_);
		...
		{	// result = variable * parameter
			...
			// put operator in the tape
			result.taddr_ = tape->Rec.PutOp(MulvpOp,result.value_);
			// make result a variable
			result.id_ = tape->id_;
		}
	}
	...
	{	if( IdenticalZero(value_) )
		...
		{	// result = parameter * variable
			...
			// put operator in the tape
			result.taddr_ = tape->Rec.PutOp(MulpvOp,result.value_);
			// make result a variable
			result.id_ = tape->id_;
		}
	}
